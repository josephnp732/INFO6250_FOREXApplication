	...
	<table table width="60%" border="1" align="center">
		...
		<c:forEach var="payment" items="${payments}">
			<tr>
				...
				<td><c:out value="${payment.month}" />/<c:out value="${payment.year}" /></td>
				<td><c:out value="${payment.zipCode}" /></td>
				<td align="center">
					<form:form action="${contextPath}/userPayment/delete" method="get" modelAttribute="user">
						<input type='hidden' name='paymentId' value='${payment.getCardId()}'/>
